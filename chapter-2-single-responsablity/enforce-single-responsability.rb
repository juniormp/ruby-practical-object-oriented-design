...
# The path to changeable and maintainable object-oriented software begins with classes that have a single 
# responsibility. Classes that do one thing isolate that thing from the rest of your application. 
